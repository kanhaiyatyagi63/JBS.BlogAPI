...
public static class MimeTypeUtility
{
    ...
    public static List<string> GetMimeTypeExtensionsByCategory(AttachmentTypeOptions? attachmentType)
    {
        ...
        {
            case AttachmentTypeOptions.Document:
                return new List<string>() { "doc", "docx", "txt" };
            case AttachmentTypeOptions.Pdf:
                return new List<string>() { "pdf" };
            case AttachmentTypeOptions.SpreadSheet:
                return new List<string>() { "xls", "xlt", "xlsx", "csv" };
            case AttachmentTypeOptions.Audio:
            case AttachmentTypeOptions.Image:
            case AttachmentTypeOptions.Video:
                return s_typeMap
                        .Where(keyPair => keyPair.Value.StartsWith($"{attachmentType.ToString()}/", StringComparison.OrdinalIgnoreCase))
                        .Select(keyPair => keyPair.Key).ToList();
            default: throw new ArgumentException($"{nameof(attachmentType)} is not valid");
        }
    }
}
